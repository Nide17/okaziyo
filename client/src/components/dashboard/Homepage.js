                        ...
                        <ul className="nav pcoded-inner-navbar">
                            ...
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" className="nav-item pcoded-hasmenu">
                                ...
                                <a href="/#" className="nav-link ">
                                    ...
                                    <span className="pcoded-micon"><i className="feather icon-box"></i></span><span className="pcoded-mtext">Components</span></a>
                            ...
                            <li data-username="Authentication Sign up Sign in reset password Change password Personal information profile settings map form subscribe" className="nav-item pcoded-hasmenu">
                                ...
                                {/* <a href="javascript:" className="nav-link "> */}
                                <a href="/#" className="nav-link ">
                                    <span className="pcoded-micon"><i className="feather icon-lock"></i></span><span className="pcoded-mtext">Authentication</span></a>
                                <ul className="pcoded-submenu">
                            ...
                            <li data-username="Disabled Menu" className="nav-item disabled">
                                ...
                                <a href="/#" className="nav-link">
                                    ...
                                    <span className="pcoded-micon"><i className="feather icon-power"></i></span><span className="pcoded-mtext">Disabled menu</span></a></li>
                        </ul>
                    </div>
                                ...
                                <div className="dropdown-menu dropdown-menu-right notification">
                                    ...
                                    <ul className="noti-body">
                                        ...
                                        <li className="notification">
                                            <div className="media">
                                                <img className="img-radius" src="assets/images/user/avatar-1.jpg" alt="Generic placeholder imge" />
                                        ...
                                        <li className="notification">
                                            ...
                                            <div className="media">
                                                <img className="img-radius" src="assets/images/user/avatar-2.jpg" alt="Generic placeholder imge" />
                                                <div className="media-body">
                                        ...
                                        <li className="notification">
                                            <div className="media">
                                                <img className="img-radius" src="assets/images/user/avatar-3.jpg" alt="Generic placeholder imge" />
                                                <div className="media-body">
