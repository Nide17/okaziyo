...
const rootReducer = combineReducers({ subscribersReducer, errorReducer, authReducer, categoriesReducer, itemsReducer, contactsReducer, jobsReducer, scholarshipsReducer });
